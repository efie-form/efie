import type { FieldSystemConfigCharacterLimit, PropValueLimit } from '@efie-form/core';
...
interface SystemSettingsCharacterLimitProps {
  fieldId: string;
  config: FieldSystemConfigCharacterLimit;
}

const defaultLimit: PropValueLimit = { min: undefined, max: undefined };

export default function SystemSettingsCharacterLimit({
  fieldId,
  config,
}: SystemSettingsCharacterLimitProps) {
