...
import FieldPropertiesTab from './tabs/FieldPropertiesTab';
import { cn } from '@form-builder/lib/utils';
import PagePropertiesTab from './tabs/PagePropertiesTab';
import { AiFillLayout } from 'react-icons/ai';
import type { ElementType } from 'react';
import type { RightBarTab } from '@form-builder/lib/state/settings.state';
import { RIGHT_BAR_TABS } from '@form-builder/lib/state/settings.state';
...
import Tooltip from '@form-builder/components/elements/Tooltip';
