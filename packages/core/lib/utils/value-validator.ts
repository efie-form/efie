...
export function isJsonContentValue(value?: PropValue): value is PropValueString {
  return !!value && typeof value === 'object' && 'jsonContent' in value;
}
...
export function isColor(value: unknown): value is Color {
  ...
  if ('rgba' in value && value.rgba && typeof value.rgba === 'object') {
    ...
    if (
      typeof value.rgba.r !== 'number' ||
      typeof value.rgba.g !== 'number' ||
      typeof value.rgba.b !== 'number' ||
      typeof value.rgba.a !== 'number'
    ) {
      return false;
    }
  ...
  if ('hsla' in value && value.hsla && typeof value.hsla === 'object') {
    ...
    if (
      typeof value.hsla.h !== 'number' ||
      typeof value.hsla.s !== 'number' ||
      typeof value.hsla.l !== 'number' ||
      typeof value.hsla.a !== 'number'
    ) {
      return false;
    }
  ...
  if (
    ...
    /^#([A-Fa-f0-9]{3}|[A-Fa-f0-9]{4}|[A-Fa-f0-9]{6}|[A-Fa-f0-9]{8})$/.test(value.hex)
  ) {
    return true;
  }
