...
function Input({
  ...
  return (
    <div
      className={cn(
        'relative flex border border-neutral-200 rounded-md bg-white w-full items-center overflow-hidden focus-within:outline focus-within:outline-primary',
        className
      )}
    >
      ...
      <input
        ...
        className={cn(
          'outline-none w-full flex-1 py-1 text-neutral-800 placeholder-neutral-400 typography-body3',
          prefix ? 'ps-1' : 'ps-2',
          suffix ? 'pe-1' : 'pe-2'
        )}
      />
