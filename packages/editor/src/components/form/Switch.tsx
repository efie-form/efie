...
function Switch({ checked, onChange }: SwitchProps) {
  ...
  return (
    <SwitchPrimitive.Root
      ...
      className="relative h-5 w-9 focus:outline-primary cursor-pointer bg-neutral-200 border border-neutral-200 rounded-full outline-none data-[state=checked]:bg-primary transition-all duration-300 data-[state=checked]:border-primary"
    >
